    ...
    public partial class _20240813InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PipeProperty_Condition", x => x.PipePropertyConditionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "PipeProperty_ConditionId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JointsPerTier = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TallyEquipment", x => new { x.TallyId, x.EquipmentId });
                    table.ForeignKey(
                        name: "FK_TallyEquipment_Equipment_EquipmentId",
                        column: x => x.EquipmentId,
                        principalTable: "Equipment",
                        principalColumn: "EquipmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TallyEquipment_Tally_TallyId",
                        column: x => x.TallyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TallyEquipment_EquipmentId",
                table: "TallyEquipment",
                column: "EquipmentId");
