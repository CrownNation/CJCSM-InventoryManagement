...
namespace Inventory_BLL.BL
{
    public class CustomerBL : ICustomerBL
    {
        ...
        {
            // Define the query
            var customerQuery = _context.Customer.Where(x => x.CustomerId == guid);

            // Project to DtoCustomer
            var dtoCustomerQuery = _mapper.ProjectTo<DtoCustomer>(customerQuery);

            // Return the IQueryable. No query has been executed at this point.
            return dtoCustomerQuery;
        }
